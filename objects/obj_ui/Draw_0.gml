...
// Display Player Name
draw_text(20, 240, "Character Selected: " + string(global.player_name));
...
if (global.current_adventure_character != -1) {
    ...
    draw_text(20, 320, char_stats);
} else {
    draw_text(20, 320, "No Character Selected");
}
...
draw_text(20, 380, crafted_weapons);
